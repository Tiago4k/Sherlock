...
import Cleaning_Scripts.directory_helper as dh
from Cleaning_Scripts.image_loader import load_train_array, load_test_array, load_img_array
...
# Load images into X so we can Train/Test Split.
# Load Y with an array of 2000 values, 1300 real, 700 fake.
X = load_img_array(const.PATH_TO_REALS, const.PATH_TO_FAKES)
Y = [0]*1300+[1]*700
